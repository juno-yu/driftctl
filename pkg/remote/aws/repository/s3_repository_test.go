...
func Test_s3Repository_ListAllBuckets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantErr == nil {
				cachedGot, err := r.ListAllBuckets()
				assert.Nil(t, err)
				assert.Equal(t, got, cachedGot)
			}
		})
	}
}
...
func Test_s3Repository_ListBucketInventoryConfigurations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Ensure cache was populated
			if err != nil {
				cachedGot, err := r.ListBucketInventoryConfigurations(&tt.input.bucket, tt.input.region)
				assert.Nil(t, err)
				assert.Equal(t, got, cachedGot)
			}
		})
...
func Test_s3Repository_ListBucketMetricsConfigurations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Ensure cache was populated
			if err != nil {
				cachedGot, err := r.ListBucketMetricsConfigurations(&tt.input.bucket, tt.input.region)
				assert.Nil(t, err)
				assert.Equal(t, got, cachedGot)
			}
		})
...
func Test_s3Repository_ListBucketAnalyticsConfigurations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Ensure cache was populated
			if err != nil {
				cachedGot, err := r.ListBucketAnalyticsConfigurations(&tt.input.bucket, tt.input.region)
				assert.Nil(t, err)
				assert.Equal(t, got, cachedGot)
			}
		})
...
func Test_s3Repository_GetBucketLocation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Ensure cache was populated
			if err != nil {
				cachedGot, err := r.GetBucketLocation(tt.bucket)
				assert.Nil(t, err)
				assert.Equal(t, got, cachedGot)
			}
		})
